...
public static class BenchmarkManager
{
    ...
    static BenchmarkManager() // For csv data saving
    {
        ...
        {
            File.AppendAllText(CsvFilePath, "Timestamp,Players,Sync_Method,Extra_Packets,Duration_Microseconds\n");
        }
    }
    ...
    public static ulong AmountOfExtraClientBytes = 1_500_000_000;
    public static uint AmountOfExtraServerDatas = 1;
    /// <summary>
